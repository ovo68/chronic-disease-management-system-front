<template>
  <div>
    <sn-text text="今日会员消费占比" font-weight="bold" :font-size="16"/>
...
export default {
  ...
  watch: {
    pieData(val) {
      this.chartPieData = val.chartPieData
  ...
  data() {
    return {
      ...
      money: '',
      // chartPieData: [
      //   {value: 90.1, name: '会员消费占比44.1%'},
      //   {value: 9.9, name: '非会员消费占比55.9%'},
      // ],
      // money: '4200.00',
    }
  },
