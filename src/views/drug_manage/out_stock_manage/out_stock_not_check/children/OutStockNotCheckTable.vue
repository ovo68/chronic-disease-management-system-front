<template>
  <div>
    <out-stock-not-check-table-title class="margin-bottom-20"/>
    <el-table
...
<script>
import OutStockNotCheckTableTitle
  from "@/views/drug_manage/out_stock_manage/out_stock_not_check/children/OutStockNotCheckTableTitle";

export default {
  name: "OutStockPassCheckTable",
  components: {
    OutStockNotCheckTableTitle
  },
  data() {
    return {
      //每页数据
