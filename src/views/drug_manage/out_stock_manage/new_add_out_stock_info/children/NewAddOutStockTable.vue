<template>
  <div>
    <new-add-out-stock-table-title class="margin-bottom-20"/>
    <el-table
...
<script>
import NewAddOutStockTableTitle
  from "@/views/drug_manage/out_stock_manage/new_add_out_stock_info/children/NewAddOutStockTableTitle";

export default {
  name: "NewAddOutStockTable",
  components: {
    NewAddOutStockTableTitle
  },
  data() {
    return {
      //每页数据
