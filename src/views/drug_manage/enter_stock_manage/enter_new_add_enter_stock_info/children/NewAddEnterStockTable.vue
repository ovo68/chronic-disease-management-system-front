<template>
  <div>
    <!-- 分割线-->
    <new-add-enter-stock-table-title class="margin-bottom-20"/>
...
<script>
import NewAddEnterStockTableTitle
  from "@/views/drug_manage/enter_stock_manage/enter_new_add_enter_stock_info/children/NewAddEnterStockTableTitle";

export default {
  name: "NewAddEnterStockTable",
  components: {
    NewAddEnterStockTableTitle
  },
  data() {
    return {
      //每页数据
